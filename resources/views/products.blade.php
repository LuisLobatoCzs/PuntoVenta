...
<div class="col-12" ng-init="export()">
    ...
    <div class="row centrarY">    
        ...
        <a href="/addProducts"><button class="btn btn-warning col-12">Agregar producto</button></a>
        </div>
        <div class="col-12 col-md-3 text-center">
        <a href="/bstock"><button class="btn btn-secondary col-12">Bajo stock</button></a>
        </div>   
        <br><br><br><br>
    </div>     
