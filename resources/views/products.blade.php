                        ...
                        <tr>
                            <?php
                                foreach($categorias as $c){
                                    echo '
                                        <th class="text-center"> <button class="btn btn-success" ng-click="setCategoria('; echo"'$c->categoria'"; echo')">'.$c->categoria.'</button> </th>
                                    ';
                                }
                                if($desclasificados > 0){
                                    echo '
                                        <th class="text-center"> <button class="btn btn-success" ng-click="setCategoria('; echo"'Sin clasificar'";echo')">Sin clasificar</button> </th>
                                    ';
                                }
                            ?>
                        </tr>
